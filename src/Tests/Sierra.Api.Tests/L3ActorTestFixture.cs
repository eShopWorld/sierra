...
public class L3ActorTestFixture : IDisposable
{
    ...
    public void Dispose()
    {
        EnsureTenantDeleted().Wait(TenantApiTimeoutMs);
        Container.Dispose();
    }
...
public class ActorContainerCollection : ICollectionFixture<L3ActorTestFixture>
{
}